...
public class MyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataList.add(new DrawerItem("CyanogenMod", R.drawable.fag_ac));
        dataList.add(new DrawerItem("Own Wall", R.drawable.fag_ac));
        dataList.add(new DrawerItem("About", R.drawable.about_ac));
